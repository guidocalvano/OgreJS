...
void MyGuiEventEmitterBindJS:: emit( char* eventTypeCSTR, v8::Local<v8::Value> arg ) 
	{
...
void MyGuiEventEmitterBindJS:: mouseButtonPressed( MyGUI::Widget* _sender, int _left, int _top, MyGUI::MouseButton _id )
	{
		printf( "mouse pressed my gui\n");
 	 emit( "mousePressed", v8::String::New( "p" ) ) ;
	}

void MyGuiEventEmitterBindJS:: mouseMove( MyGUI::Widget* _sender, int _left, int _top ) 
	{
