...
PickingManager:: PickingManager()
	...
	// create the ray scene query object
	     m_pray_scene_query = OgreManager:: getSingletonPtr()-> m_pSceneMgr ->createRayQuery(Ogre::Ray(), Ogre::SceneManager::WORLD_GEOMETRY_TYPE_MASK);
...
/*
Ogre::Entity* PickingManager::RaycastFromPoint(const Ogre:: Vector3 &point,
...
Ogre::Entity* PickingManager::RaycastFromPoint(	Ogre::Ray ray,
    											Ogre:: Vector3 &result)
{
    ...
    {
		printf( "Cannot raycast without RaySceneQuery instance\n" ) ;
        return (false);
    }   
...
void PickingManager::GetMeshInformation(Ogre::Entity *entity,
									size_t &vertex_count,
									Ogre::Vector3* &vertices,
									size_t &index_count,
									Ogre::uint32* &indices,
